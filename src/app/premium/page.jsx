  ...
  return (
    <section className="min-h-screen pt-24 pb-16">
      <div className="mx-auto flex max-w-7xl flex-col gap-10 px-4 sm:px-6">
        {isPremium ? (
          <>
            <div className="overflow-hidden rounded-[2rem] border border-emerald-200/50 bg-gradient-to-br from-emerald-50 via-white to-emerald-50 p-8 shadow-sm backdrop-blur-xl dark:border-emerald-900/50 dark:from-emerald-950/30 dark:via-zinc-900 dark:to-emerald-950/20 sm:p-10">
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-100 px-4 py-1.5 text-sm font-medium text-emerald-700 dark:border-emerald-800 dark:bg-emerald-950/40 dark:text-emerald-300">
                  <PartyPopper className="h-4 w-4" />
                  Premium Active
                </div>

                <Crown className="mb-2 h-12 w-12 text-amber-500" />
                <h1 className="text-3xl font-bold tracking-tight text-zinc-900 dark:text-white sm:text-4xl">
                  You&apos;re already Premium
                </h1>
                <p className="mt-3 max-w-lg text-sm leading-7 text-zinc-600 dark:text-zinc-300 sm:text-base">
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              {benefits.map((item) => {
                ...
                return (
                  <div
                    key={item.title}
                    className="rounded-[1.75rem] border border-white/20 bg-white/70 p-6 backdrop-blur-xl dark:border-white/10 dark:bg-white/5"
                  >
          ...
          <>
            <div className="overflow-hidden rounded-[2rem] border border-white/20 bg-white/70 p-6 shadow-sm backdrop-blur-xl dark:border-white/10 dark:bg-white/5 sm:p-8 lg:p-10">
              <div className="grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
                <div>
                  <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-medium text-amber-700 dark:border-amber-900 dark:bg-amber-950/30 dark:text-amber-300">
                ...
                <div className="rounded-[2rem] border border-white/20 bg-gradient-to-br from-emerald-500 to-teal-500 p-6 text-white shadow-xl shadow-emerald-500/20 dark:border-white/10 sm:p-8">
            ...
            <div className="rounded-[2rem] border border-white/20 bg-white/70 p-6 backdrop-blur-xl dark:border-white/10 dark:bg-white/5 sm:p-8">
              ...
              <div className="mt-6 overflow-hidden rounded-[1.5rem] border border-white/20 dark:border-white/10">
